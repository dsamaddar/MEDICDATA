...
public partial class RptCasualty : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptCausalty.cs", "Page_Load", Ex.Message, System.DateTime.Now.ToString());
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptCausalty.cs", "btnSearch_Click", ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindYear()
    {
        ...
        {
            Obj.ErrorLog("RptCausalty.cs", "BindYear", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindMonth()
    {
        ...
        {
            Obj.ErrorLog("RptCausalty.aspx", "BindMonth", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void GetHospitalDrp()
    {
        ...
        {
            Obj.ErrorLog("RptCausalty.cs", "GetServicesDrp", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindReport()
    {
        try
        {
            ...
            if (d.HType2 > 0)
            {
                Ds = Obj.RptGetCasualtyComplex(SMonth, CurrentYear, d.HType, StateId, txtRefNo.Text, CompanyId, d.HType1, d.HType2, d.HType3, EMonth);
                DsHead = Obj.RptGetHeaderDetails(CompanyId, 27, txtRefNo.Text, period);
            }
            else
            {
                Ds = Obj.RptGetCasualty(SMonth, CurrentYear, d.HType, StateId, txtRefNo.Text, CompanyId, d.HType1, EMonth);
            ...
            {
                ReportViewer1.LocalReport.ReportPath = "Reports\\rptCausaltyChart.rdlc";
            }
            else
            {
                ReportViewer1.LocalReport.ReportPath = "Reports\\rptCausalty.rdlc";
            }
            
            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.EnableExternalImages = true;
            ReportDataSource RDS = new ReportDataSource("DsCasualty", Ds.Tables[0]);
        ...
        {
            Obj.ErrorLog("RptCausalty.cs", "BindReport", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
