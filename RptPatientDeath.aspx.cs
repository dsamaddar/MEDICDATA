...
public partial class RptPatientDeath : System.Web.UI.Page
{
    ...
    public void BindMonth()
    {
        ...
        {
            Obj.ErrorLog("RptPatientDeath.aspx", "BindMonth", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindReport()
    {
        try
        {
            ...
            if (d.HType1 > 0)
            {
                Ds = Obj.RptGetPatientDeathComplex(SMonth, CurrentYear, d.HType, StateId, txtRefNo.Text, CompanyId, d.HType1, EMonth);
                DsHead = Obj.RptGetHeaderDetails(CompanyId, 27, txtRefNo.Text, period);
            }
            else
            {
                Ds = Obj.RptGetPatientDeathDetails(SMonth, CurrentYear, d.HType, StateId, txtRefNo.Text, CompanyId, EMonth);
                DsHead = Obj.RptGetHeaderDetails(CompanyId, d.HType, txtRefNo.Text, period);
            }            
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = "Reports\\rptPatientDeath.rdlc";
            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.EnableExternalImages = true;
            ReportDataSource RDS = new ReportDataSource("DsDeath", Ds.Tables[0]);
