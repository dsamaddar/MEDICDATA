...
public partial class RptHospitalBeds : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptHospitalBeds.cs", "Page_Load", Ex.Message, System.DateTime.Now.ToString());
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptHospitalBeds.cs", "btnSearch_Click", ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindMonth()
    {
        ...
        {
            Obj.ErrorLog("RptHospitalBeds.aspx", "BindMonth", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindYear()
    {
        ...
        {
            Obj.ErrorLog("RptHospitalBeds.cs", "BindYear", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void GetHospitalDrp()
    {
        ...
        {
            Obj.ErrorLog("RptHospitalBeds.cs", "GetHospitalDrp", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindReport()
    {
        try
        {
            ...
            Ds = Obj.RptGetAllHosptBEDS(CompanyId, StateId, "", SMonth, CurrentYear, Obj.strtoint(d.HType.ToString()), txtRefNo.Text, EMonth);
            Ds1 = Obj.RptGetAllHosptOutCome(CompanyId, StateId, "", SMonth, CurrentYear, Obj.strtoint(d.HType.ToString()), txtRefNo.Text, EMonth);
            if (Obj.chkdataset(Ds))
            {
                ...
                {
                    ReportViewer1.LocalReport.ReportPath = "Reports\\HospitalBedsChart.rdlc";
                }
                else
                {
                    ReportViewer1.LocalReport.ReportPath = "Reports\\HospitalBeds.rdlc";
                }
                ReportViewer1.LocalReport.DataSources.Clear();
                ReportViewer1.LocalReport.EnableExternalImages = true;
                ReportDataSource RDS = new ReportDataSource("RptHosptBEDS", Ds.Tables[0]);
                ReportDataSource RDS2 = new ReportDataSource("DSHead", DsHead.Tables[0]);
                ReportViewer1.LocalReport.DataSources.Add(RDS);
                ReportViewer1.LocalReport.DataSources.Add(RDS2);
                ReportDataSource RDS1 = new ReportDataSource("RptHosptOutCome", Ds1.Tables[0]);
                ReportViewer1.LocalReport.DataSources.Add(RDS1);
            }
        }
        catch (Exception Ex)
        {
            Obj.ErrorLog("RptHospitalBeds.cs", "BindReport", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
}