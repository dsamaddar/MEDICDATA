...
public partial class MonthlyData : System.Web.UI.Page
{
    ...
    public void BindReport()
    {
        try
        {
            ...
            Ds = Obj.GetCMF(SMonth, CurrentYear, d.HType, d.HType1, StateId, txtRefNo.Text, CompanyId, EMonth);
            DSHead = Obj.RptGetHeaderDetails(CompanyId, d.HType, txtRefNo.Text, period);

            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = "Reports\\RptCMF.rdlc";

            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.EnableExternalImages = true;

            ReportDataSource RDS = new ReportDataSource("CMF12", Ds.Tables[0]);
