...
public partial class RptInPatientAdmission : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptInPatientAdmission.cs", "Page_Load", Ex.Message, System.DateTime.Now.ToString());
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptInPatientAdmission.cs", "btnSearch_Click", ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindMonth()
    {
        ...
        {
            Obj.ErrorLog("RptInPatientAdmission.aspx", "BindMonth", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindYear()
    {
        ...
        {
            Obj.ErrorLog("RptInPatientAdmission.cs", "BindYear", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void GetHospitalDrp()
    {
        ...
        {
            Obj.ErrorLog("RptInPatientAdmission.cs", "GetHospitalDrp", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindReport()
    {
        try
        {
            ...
            DataSet Ds = new DataSet();
            Ds = Obj.RptGetPatientAdmitOutcomes(CompanyId, StateId, "", SMonth, CurrentYear, Obj.strtoint(d.HType.ToString()), txtRefNo.Text, EMonth);
            if (Obj.chkdataset(Ds))
            {
                ...
                {
                    ReportViewer1.LocalReport.ReportPath = "Reports\\InPatientAdmiOutComesChart.rdlc";
                }
                else
                {
                    ReportViewer1.LocalReport.ReportPath = "Reports\\InPatientAdmiOutComes.rdlc";
                }
                
                ReportViewer1.LocalReport.DataSources.Clear();
                ReportViewer1.LocalReport.EnableExternalImages = true;
                ReportDataSource RDS = new ReportDataSource("DsPatient", Ds.Tables[0]);
        ...
        {
            Obj.ErrorLog("RptInPatientAdmission.cs", "BindReport", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
}