<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true"
    CodeFile="RptCMF.aspx.cs" Inherits="MonthlyData" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form-row">
        ...
        <div class="form-group input-area col-md-2">
         ...
         <div class="form-group col-md-1" style="padding-top: 8px;display:none;">
    ...
    <div class="row mt-4">
        <div class="col-lg-12">
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                ...
                WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="700px" width="1000px" CssClass="Report">
                <LocalReport ReportPath="Reports\MonthlyData.rdlc">
                </LocalReport>
            </rsweb:ReportViewer>
        </div>
    </div>
