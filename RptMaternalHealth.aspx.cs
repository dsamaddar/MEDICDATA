...
public partial class RptMaternalHealth : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptMaternalHealth.cs", "Page_Load", Ex.Message, System.DateTime.Now.ToString());
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptMaternalHealth.cs", "btnSearch_Click", ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindMonth()
    {
        ...
        {
            Obj.ErrorLog("RptMaternalHealth.aspx", "BindMonth", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindYear()
    {
        ...
        {
            Obj.ErrorLog("RptMaternalHealth.cs", "BindYear", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void GetHospitalDrp()
    {
        ...
        {
            Obj.ErrorLog("RptMaternalHealth.cs", "GetHospitalDrp", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindReport()
    {
        try
        {
            ...
            DataSet Ds = new DataSet();
            Ds = Obj.RptGetMaternalHealth(CompanyId, StateId, "", SMonth, CurrentYear, Obj.strtoint(d.HType.ToString()), txtRefNo.Text, EMonth);
            if (Obj.chkdataset(Ds))
            {
                ...
                {
                    ReportViewer1.LocalReport.ReportPath = "Reports\\MaternalHealthChart.rdlc";
                }
                else
                {
                    ReportViewer1.LocalReport.ReportPath = "Reports\\MaternalHealth.rdlc";
                }
                
                ReportViewer1.LocalReport.DataSources.Clear();
                ReportViewer1.LocalReport.EnableExternalImages = true;
                ReportDataSource RDS = new ReportDataSource("DsMaternal", Ds.Tables[0]);
        ...
        {
            Obj.ErrorLog("RptMaternalHealth.cs", "BindReport", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
}