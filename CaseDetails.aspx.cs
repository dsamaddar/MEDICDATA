...
public partial class Home : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Session["UserType"] != null)
                {
                    BindYear();
                    BindMonth();
                    if (d.HType >= 101 && d.HType <= 110)
                    {
                        hdActiveMenu.Value = "A";
                        PageA.CssClass = "TopHeadingMenu MActive";
                        ABCDMenu.Visible = true;
                    }
                    BindDgvCD1();
                }
        ...
        {
            Obj.ErrorLog("CaseDetails.aspx", "Page_Load", Ex.Message, System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindYear()
    {
        ...
        {
            Obj.ErrorLog("CaseDetails.aspx", "BindYear", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindMonth()
    {
        ...
        {
            Obj.ErrorLog("CaseDetails.aspx", "BindMonth", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindDgvCD1()
    {
        try
        {
            ...
            CaseType.Value = d.CaseType.ToString();
            GenderType.Value = d.GenderType.ToString();
            ...
            Ds = Obj.GetCaseDetail(Obj.strtoint(GroupId.Value), month, year, Obj.strtoint(HType.Value), Obj.strtoint(CaseType.Value), Obj.strtoint(GenderType.Value), TStateId, CompanyId, SearchVal);
            if (Obj.chkdataset(Ds))
            {
        ...
        {
            Obj.ErrorLog("CaseDetails.aspx", "BindDgvCD1", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("CaseDetails.aspx", "Btnsearch_Click", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    protected void PageA_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("CaseDetails.aspx", "PageA_Click", ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
}