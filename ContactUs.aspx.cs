...
public partial class ContactUs : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("ContactUs.cs", "Page_Load", Ex.Message, System.DateTime.Now.ToString());
        }
    }
    ...
    protected void btnContact_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("ContactUs.cs", "btnContact_Click", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
