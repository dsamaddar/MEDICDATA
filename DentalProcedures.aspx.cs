...
public partial class DentalProcedures : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("DentalProcedures.aspx", "btnSearch_Click", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindDgvCD1()
    {
        try
        {
            ...
            Ds = Obj.GetDentalProcedure(Obj.strtoint64(CompanyId.Value.ToString()), Obj.strtoint64(StateId.Value.ToString()), System.Environment.MachineName.ToString(), month, year, Obj.strtoint(HType.Value.ToString()));
        ...
        {
            Obj.ErrorLog("DentalProcedures.aspx", "BindDgvCD1", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindYear()
    {
        ...
        {
            Obj.ErrorLog("DentalProcedures.aspx", "BindYear", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindMonth()
    {
        ...
        {
            Obj.ErrorLog("DentalProcedures.aspx", "BindMonth", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
}