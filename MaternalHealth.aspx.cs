...
public partial class MaternalHealth : System.Web.UI.Page
{
    ...
    public void BindDgvCD1()
    {
        try
        {
            ...
            Ds = Obj.GetMaternalHealth(Obj.strtoint64(CompanyId.Value.ToString()), Obj.strtoint64(StateId.Value.ToString()), System.Environment.MachineName.ToString(), month, year, Obj.strtoint(HType.Value.ToString()));
