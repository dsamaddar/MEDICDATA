...
public partial class RptDentalProcedure : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptDentalProcedure.cs", "Page_Load", Ex.Message, System.DateTime.Now.ToString());
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptDentalProcedure.cs", "btnSearch_Click", ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindMonth()
    {
        ...
        {
            Obj.ErrorLog("RptDentalProcedure.aspx", "BindMonth", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindYear()
    {
        ...
        {
            Obj.ErrorLog("RptDentalProcedure.cs", "BindYear", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void GetHospitalDrp()
    {
        ...
        {
            Obj.ErrorLog("RptDentalProcedure.cs", "GetHospitalDrp", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindReport()
    {
        try
        {
            ...
            DataSet Ds = new DataSet();
            Ds = Obj.RptGetDentalProcedure(CompanyId, StateId, "", SMonth, CurrentYear, Obj.strtoint(d.HType.ToString()), txtRefNo.Text, EMonth);
            if (Obj.chkdataset(Ds))
            {
                ...
                {
                    ReportViewer1.LocalReport.ReportPath = "Reports\\DentalProcedureChart.rdlc";
                }
                else
                {
                    ReportViewer1.LocalReport.ReportPath = "Reports\\DentalProcedure.rdlc";
                }
                ReportViewer1.LocalReport.DataSources.Clear();
                ReportViewer1.LocalReport.EnableExternalImages = true;
                ReportDataSource RDS = new ReportDataSource("DsDental", Ds.Tables[0]);
        ...
        {
            Obj.ErrorLog("RptDentalProcedure.cs", "BindReport", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
}