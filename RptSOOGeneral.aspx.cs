...
public partial class RptSOOGeneral : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptSOOGeneral.cs", "Page_Load", Ex.Message, System.DateTime.Now.ToString());
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptSOOGeneral.cs", "btnSearch_Click", ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindMonth()
    {
        ...
        {
            Obj.ErrorLog("RptSOOGeneral.aspx", "BindMonth", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindYear()
    {
        ...
        {
            Obj.ErrorLog("RptSOOGeneral.cs", "BindYear", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void GetHospitalDrp()
    {
        ...
        {
            Obj.ErrorLog("RptSOOGeneral.cs", "GetServicesDrp", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindReport()
    {
        try
        {
            ...
            if (d.HType2 > 0)
            {
                Ds = Obj.RptSOOComplex(SMonth, CurrentYear, StateId, txtRefNo.Text, CompanyId, d.HType, d.HType1, d.HType2, d.HType3, EMonth);
                DsHead = Obj.RptGetHeaderDetails(CompanyId, 27, txtRefNo.Text, period);
            }
            else
            {
                Ds = Obj.RptSOOGeneral(SMonth, CurrentYear, StateId, txtRefNo.Text, CompanyId, d.HType, d.HType1, EMonth);
                DsHead = Obj.RptGetHeaderDetails(CompanyId, d.HType, txtRefNo.Text, period);
            }
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            if (chkchart.Checked == true)
            {
                ReportViewer1.LocalReport.ReportPath = "Reports\\rptSOOGenChart.rdlc";
            }
            else
            {
                ReportViewer1.LocalReport.ReportPath = "Reports\\rptSOOGen.rdlc";
            }
            
            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.EnableExternalImages = true;
            ReportDataSource RDS = new ReportDataSource("DsSOO", Ds.Tables[0]);
        ...
        {
            Obj.ErrorLog("RptSOOGeneral.cs", "BindReport", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
