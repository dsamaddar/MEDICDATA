...
public partial class RptGovABAG : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptGovABAG.cs", "Page_Load", Ex.Message, System.DateTime.Now.ToString());
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptGovABAG.cs", "btnSearch_Click", ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindMonth()
    {
        ...
        {
            Obj.ErrorLog("RptGovABAG.aspx", "BindMonth", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindYear()
    {
        ...
        {
            Obj.ErrorLog("RptGovABAG.cs", "BindYear", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void GetHospitalDrp()
    {
        ...
        {
            Obj.ErrorLog("RptGovABAG.cs", "GetHospitalDrp", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindReport()
    {
        try
        {
            ...
            DataSet Ds = new DataSet();
            Ds = Obj.RptGovABAG(SMonth, EMonth, CurrentYear, CompanyId, D.HType, FromDate, ToDate, DateMode);

            ReportViewer1.ProcessingMode = ProcessingMode.Local;

            if (chkchart.Checked == true)
            {
                ReportViewer1.LocalReport.ReportPath = "Reports\\RptGovABAGChart.rdlc";
            }
            else
            {
                ReportViewer1.LocalReport.ReportPath = "Reports\\RptGovABAG.rdlc";
            }
        ...
        {
            Obj.ErrorLog("RptGovABAG.cs", "BindReport", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
}