<%@ Page Title="MEDICDATA | STATE" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true"
    CodeFile="StateList.aspx.cs" Inherits="UserList" %>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <asp:Repeater ID="RptStateList" runat="server" OnItemCommand="RptStateList_ItemCommand"
                        OnItemDataBound="RptStateList_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <%# Eval("StateName")%>
