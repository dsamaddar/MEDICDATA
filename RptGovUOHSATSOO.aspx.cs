...
public partial class RptGovUOHSATSOO : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptGovUOHSATSOO.cs", "Page_Load", Ex.Message, System.DateTime.Now.ToString());
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("RptGovUOHSATSOO.cs", "btnSearch_Click", ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindMonth()
    {
        ...
        {
            Obj.ErrorLog("RptGovUOHSATSOO.aspx", "BindMonth", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindYear()
    {
        ...
        {
            Obj.ErrorLog("RptGovUOHSATSOO.cs", "BindYear", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void GetHospitalDrp()
    {
        ...
        {
            Obj.ErrorLog("RptGovUOHSATSOO.cs", "GetHospitalDrp", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindReport()
    {
        try
        {
            ...
            DataSet Ds = new DataSet();
            Ds = Obj.RptGovUOHSATSOO(SMonth, EMonth, CurrentYear, CompanyId, D.HType, D.HType1, FromDate, ToDate, DateMode);

            ReportViewer1.ProcessingMode = ProcessingMode.Local;

            if (chkchart.Checked == true)
            {
                ReportViewer1.LocalReport.ReportPath = "Reports\\RptGovUOHSATSOOChart.rdlc";
            }
            else
            {
                ReportViewer1.LocalReport.ReportPath = "Reports\\RptGovUOHSATSOO.rdlc";
            }
        ...
        {
            Obj.ErrorLog("RptGovUOHSATSOO.cs", "BindReport", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
}