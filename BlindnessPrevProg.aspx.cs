...
public partial class BlindnessPrevProg : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("BlindnessPrevProg.aspx", "btnSearch_Click", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    protected void PageA_Click(object sender, EventArgs e)
    {
        ...
        {
            Obj.ErrorLog("BlindnessPrevProg.aspx", "PageA_Click", ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindDgvCD1()
    {
        try
        {
            ...
            Ds = Obj.GetBlindnessPreProg(Obj.strtoint64(CompanyId.Value.ToString()), Obj.strtoint64(StateId.Value.ToString()), System.Environment.MachineName.ToString(), month, year, Obj.strtoint(HType.Value.ToString()));
            if (Obj.chkdataset(Ds))
            {
                RPTBlindess.DataSource = Ds.Tables[0];
                RPTBlindess.DataBind();
            }
            else
            {
                RPTBlindess.DataSource = null;
                RPTBlindess.DataSource = "";
                RPTBlindess.DataBind();
            }
        }
        catch (Exception Ex)
        {
            Obj.ErrorLog("BlindnessPrevProg.aspx", "BindDgvCD1", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindYear()
    {
        ...
        {
            Obj.ErrorLog("BlindnessPrevProg.aspx", "BindYear", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
    ...
    public void BindMonth()
    {
        ...
        {
            Obj.ErrorLog("BlindnessPrevProg.aspx", "BindMonth", Ex.Message.ToString(), System.DateTime.Now.ToString());
        }
    }
}